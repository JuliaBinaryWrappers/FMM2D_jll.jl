# `FMM2D_jll.jl` (v1.1.0+0)

[![deps](https://juliahub.com/docs/FMM2D_jll/deps.svg)](https://juliahub.com/ui/Packages/FMM2D_jll/nQLxC?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/1f1bef9b38cd3b4e7144d26b785147e28a99dfd3/F/FMM2D/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `FMM2D_jll.jl` have been built from these sources:

* git repository: https://github.com/flatironinstitute/fmm2d.git (revision: `887907742394467587358a81a22b537edb58acf7`)

## Platforms

`FMM2D_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `FMM2D_jll.jl`:
